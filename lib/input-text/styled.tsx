...
export const ContainerInput = styled.div<Props>`
  ...
  ${ props => (props.fill && !props.active && props.valid) && `border: 1px solid ${COLORS.GRAY_4};`}
  ${ props => (props.active) && `border: 1px solid ${COLORS.GRAY};`}
  ${ props => (props.fill && !props.valid && !props.active) && `border: 1px solid ${COLORS.RED};`}
   &:hover{
        border: 1px solid ${ props => props.disabled ? COLORS.GRAY_4 : COLORS.GRAY};
    }
